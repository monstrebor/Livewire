...
<body>
    ...
    <div> <button class="btn btn-primary" id="download">PDF</button> </div>
...
<div id="form" class="whole border">
    ...
    <div> <div class="flexEnd">
        ...
        <div> <div class="flex w1 bb1"> <div class="rhead w1">
            ...
            <div class="flex w1 bb1"> <div class="w1"> <p class="c p pt br1">data</p>
            </div> <div class="w1"> <p class="c p pt">data</p> </div> </div>
        </div>
        ...
        <div class="col w1 bb1">
            ...
            <div class="w1"><p class="c p">data</p></div>
        </div>
        ...
        <div class="col w1 bb1"> <div class="br1" style="width: 220px;">
            ...
            </div><div class="w4"><p class="c p">data</p></div>
        </div>

        <div class="col w1 bb1">
            <div class="bc br1" style="width: 250px;"><p class="c p">Spouse Name:
            </p></div> <div class="w4 br1"><p class="c p"><i>data</i></p></div>
            <div class="bc w4 br1"><p class="c p">Date/Place of Marriage:</p></div>
            <div class="w4"><p class="c p">data</p></div>
        </div>
